...
export const gradient = {
  ...
  electricFade:
    "linear-gradient(135deg, oklch(0.46 0.24 262) 0%, oklch(0.72 0.22 246) 100%)",
  neonFade:
    "linear-gradient(135deg, oklch(0.65 0.24 152) 0%, oklch(0.86 0.24 148) 100%)",
  goldFade:
    "linear-gradient(135deg, oklch(0.70 0.16 80) 0%, oklch(0.84 0.16 88) 100%)",
  heatmap:
    "radial-gradient(circle, oklch(0.65 0.24 22 / 0.8) 0%, oklch(0.65 0.24 22 / 0) 70%)",
  matrixRow:
